...
class _FallbackClient implements FallbackClient {
  ...
  resolveMembershipForStaffMobile({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostV1StaffMembershipsResolveResponse _value;
    try {
      _value = PostV1StaffMembershipsResolveResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PostV1StaffOperationsStampsResponse> issueStaffMobileStamps({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostV1StaffOperationsStampsResponse _value;
    try {
      _value = PostV1StaffOperationsStampsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PostV1StaffOperationsRedeemResponse> redeemStaffMobileReward({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostV1StaffOperationsRedeemResponse _value;
    try {
      _value = PostV1StaffOperationsRedeemResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  getStaffMobileOperation({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late GetV1StaffOperationsOperationPublicIdResponse _value;
    try {
      _value = GetV1StaffOperationsOperationPublicIdResponse.fromJson(
        _result.data!,
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  recoverStaffMobileCommand({
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/v1/staff/operations/commands/${commandId}',
    )..data = _data;
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late GetV1StaffOperationsCommandsCommandIdResponse _value;
    try {
      _value = GetV1StaffOperationsCommandsCommandIdResponse.fromJson(
        _result.data!,
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
