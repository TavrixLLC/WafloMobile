...
@JsonEnum()
enum OperationCommandStatusResultOperationType {
  ...
  const OperationCommandStatusResultOperationType(this.json);

  factory OperationCommandStatusResultOperationType.fromJson(String json) =>
  ...
  static List<OperationCommandStatusResultOperationType> get $valuesDefined =>
