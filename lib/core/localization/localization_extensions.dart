...
extension WafloLocalizationX on AppLocalizations {
  ...
  String m2ErrorMessage(String? code) {
    // Historical M2 evidence still exercises this retired wire code. Keep its
    // safe copy isolated here; Production-v1 authority is
    // PURCHASE_THRESHOLD_NOT_MET and no current request path emits the alias.
    if (code == 'PURCHASE_AMOUNT_BELOW_MINIMUM') {
      return m2PurchaseThreshold;
    }
    return switch (code) {
      ...
      'MANAGER_APPROVAL_APPROVER_INACTIVE' => m2ManagerApproval,
      ...
      'STAFF_USER_DEACTIVATED' => staffUserDeactivatedBody,
      'STAFF_MEMBERSHIP_INACTIVE' => staffMembershipInactiveBody,
      'STAFF_LOCATION_ASSIGNMENT_INVALID' => staffLocationInvalidBody,
      'APP_UPDATE_REQUIRED' ||
