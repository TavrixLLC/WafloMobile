...
final class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget appearancePane() => Column(
      key: const Key('settings-preferences-pane'),
      ...
      children: [
        ...
        WafloSelectField<ThemeMode>(
          ...
          onSelected: (selected) => unawaited(
            ref.read(themeControllerProvider.notifier).setThemeMode(selected),
          ),
        ),
        ...
        WafloSurfaceCard(
          ...
          child: SwitchListTile(
            ...
            onChanged: (value) => unawaited(
              ref.read(rapidScanControllerProvider.notifier).setEnabled(value),
            ),
    ...
    Widget systemPane() => Column(
      key: const Key('settings-system-pane'),
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        WafloSurfaceCard(
          padding: EdgeInsets.zero,
        ...
        child: WafloResponsiveListView(
          ...
          children: [
            WafloAdaptiveLayout(
              ...
              wide: WafloWideSplit(
                primary: appearancePane(),
                secondary: systemPane(),
              ),
            ),
          ],
        ),
