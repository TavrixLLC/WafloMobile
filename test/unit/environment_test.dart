...
void main() {
  ...
  test('development accepts ONLY development pairing environment', () {
    expect(
      environment(flavor: AppFlavor.development, pairing: 'development').validate(),
      isEmpty,
    );
  ...
  test('committed release configurations use only canonical HTTPS origins and pairing environments', () {
    final staging =
